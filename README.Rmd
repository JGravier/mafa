...
```{r, message=FALSE}
library(kableExtra)
tibble(`function name` = c("morphalr_segment_orientation", "morphalr_dsr", "morphalr_dsc", "morphalr_circularity",
                           "morphalr_complexity"), 
       indices = c("orientations of segments of polygons or lines", "distance of polygons to their minimal bounding rectangles", "distance of polygons to their convex hull", "Miller circularity index of polygons", "morphological complexity of polygons")) |>
  kbl() |>
  kable_minimal()
```
